...
def main():
    ...
    parser.add_argument('--content-loss', type=str, default='mse', choices=['mse', 'L1','edge_loss_mse','edge_loss_L1','ssim_loss'],
    ...
    """rain 2階餵進model output出1階和2階的norain結果"""
    ...
    """這裡benchmark放要test的dataset，不用做h5，但要照benchmark.py的init方式命名檔名"""
    benchmarks = [
        ...
        Benchmark('./Benchmarks/Rain100H/rain', './Benchmarks/Rain100H/norain', name='Rain100H')
    ...
    """這裡放training val eval data的路徑"""
    train_data_path = './dataset_31600/PreprocessedData31600_24.h5'
    val_data_path = './dataset_31600/112_val_24.h5'
    eval_data_path = './dataset_31600/PreprocessedData_eval_24.h5'
